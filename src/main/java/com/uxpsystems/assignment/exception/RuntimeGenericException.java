...
public class RuntimeGenericException extends RuntimeException implements Serializable {
	 ...
	 */
	public RuntimeGenericException(String errorMessageBundle, String errorMessageKey, String errorMessage) {
		super(errorMessage);
	 ...
	 *            original exception
	 */
	public RuntimeGenericException(String errorMessageKey, String errorMessage, Throwable originalException) {
