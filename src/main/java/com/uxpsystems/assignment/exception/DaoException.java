 ...
 * @version 1.0
 */
public class DaoException extends RuntimeGenericException implements Serializable {
	 ...
	 *            original exception
	 */
	public DaoException(String errorMessageBundle, String errorMessageKey, String errorMessage,
			Throwable originalException) {
		super(errorMessageBundle, errorMessageKey, errorMessage, originalException);
